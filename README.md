# DiGi.Geometry.Random

**DiGi.Geometry.Random** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Geometry.Random](DiGi.Geometry.Random)** (Path: `DiGi.Geometry.Random\DiGi.Geometry.Random`)
