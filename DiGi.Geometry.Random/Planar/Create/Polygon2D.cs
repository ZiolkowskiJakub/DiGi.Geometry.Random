...
namespace DiGi.Geometry.Planar.Random
{
    ...
    {
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> based on the provided <see cref="BoundingBox2D"/>.
        /// </summary>
        /// <param name="boundingBox2D">The <see cref="BoundingBox2D"/> used to derive the polygon vertices.</param>
        /// <param name="pointCount">The number of points to be included in the resulting <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/>.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> instance if the <see cref="BoundingBox2D"/> is valid and contains at least three points; otherwise, null.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> based on the provided axis-aligned bounding box, point count, and random number generator.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> if the <paramref name="boundingBox2D"/> and <paramref name="random"/> are not null and the <paramref name="pointCount"/> is at least 3; otherwise, null.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> based on the specified X and Y ranges, point count, seed, and tolerance.
        /// </summary>
        /// <param name="x">The <see cref="DiGi.Core.Classes.Range{T}"/> for the X-axis coordinates.</param>
        /// <param name="y">The <see cref="DiGi.Core.Classes.Range{T}"/> for the Y-axis coordinates.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> if both the X and Y ranges are provided; otherwise, null.</returns>
        ...
        /// <summary>
        /// Generates a <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> based on the specified X and Y ranges, point count, random number generator, and tolerance.
        /// </summary>
        /// <param name="x">The <see cref="DiGi.Core.Classes.Range{T}"/> defining the extent of the polygon along the X-axis.</param>
        /// <param name="y">The <see cref="DiGi.Core.Classes.Range{T}"/> defining the extent of the polygon along the Y-axis.</param>
        /// <param name="pointCount">The integer number of points to generate for the <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/>.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> if the X range, Y range, and random generator are provided; otherwise, null.</returns>
        ...
        /// <summary>
        /// Generates a <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> based on specified coordinate and point count ranges.
        /// </summary>
        /// <param name="x">The <see cref="DiGi.Core.Classes.Range{T}"/> of double values defining the X-axis boundaries.</param>
        /// <param name="y">The <see cref="DiGi.Core.Classes.Range{T}"/> of double values defining the Y-axis boundaries.</param>
        /// <param name="pointCount">The <see cref="DiGi.Core.Classes.Range{T}"/> of integer values defining the possible number of vertices in the polygon.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> instance if both X and Y ranges are provided; otherwise, null.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> within the specified X and Y ranges, with a number of points determined by the provided point count range.
        /// </summary>
        ...
        /// <param name="pointCount">The <see cref="DiGi.Core.Classes.Range{T}"/> used to randomly determine the number of vertices in the polygon.</param>
        ...
        /// <returns>A randomly generated <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> if both the X and Y ranges are provided; otherwise, null.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> from the specified <see cref="IPolygonal2D"/> source using a defined number of points and an optional random seed.
        /// </summary>
        /// <param name="polygonal2D">The <see cref="IPolygonal2D"/> source geometry used to generate the polygon.</param>
        /// <param name="pointCount">The integer number of points to be included in the resulting <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/>.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> instance if the <paramref name="polygonal2D"/> is not null and the <paramref name="pointCount"/> is 3 or greater; otherwise, null.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> with a specified number of vertices based on the provided <see cref="IPolygonal2D"/> geometry, ensuring that the resulting polygon does not self-intersect and its segments do not intersect the source geometry.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> instance containing the generated vertices if successful; otherwise, <see langword="null"/> if the inputs are invalid or a valid polygon cannot be constructed.</returns>
        ...
        /// <summary>
        /// Generates a <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> from an <see cref="IPolygonal2D"/> source using a randomly determined number of points.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Planar.Classes.Polygon2D"/> instance if the operation is successful; otherwise, <c>null</c> if <paramref name="polygonal2D"/>, <paramref name="pointCount"/>, or <paramref name="random"/> is <c>null</c>.</returns>
