...
namespace DiGi.Geometry.Planar.Random
{
    ...
    {
        /// <summary>
        /// Generates a <see cref="Classes.PolygonalFace2D" /> based on the specified coordinate ranges and complexity constraints.
        /// </summary>
        /// <param name="x">The <see cref="Range{T}" /> defining the range of X-coordinates.</param>
        /// <param name="y">The <see cref="Range{T}" /> defining the range of Y-coordinates.</param>
        /// <param name="pointCount">The <see cref="Range{T}" /> defining the allowed number of points.</param>
        /// <param name="internalEdgeCount">The <see cref="Range{T}" /> defining the allowed number of internal edges.</param>
        ...
        /// <returns>A <see cref="Classes.PolygonalFace2D" /> if <paramref name="x" />, <paramref name="y" />, <paramref name="pointCount" />, and <paramref name="internalEdgeCount" /> are provided; otherwise, null.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="Classes.PolygonalFace2D"/> based on the specified coordinate ranges, point counts, and number of internal edges.
        /// </summary>
        /// <param name="x">The <see cref="Range{T}"/> specifying the range for the X-axis coordinates.</param>
        /// <param name="y">The <see cref="Range{T}"/> specifying the range for the Y-axis coordinates.</param>
        /// <param name="pointCount">The <see cref="Range{T}"/> specifying the number of points to be used in the polygons.</param>
        /// <param name="internalEdgeCount">The <see cref="Range{T}"/> specifying the number of internal edges (holes) to generate within the face.</param>
        ...
        /// <returns>A randomly generated <see cref="Classes.PolygonalFace2D"/> if all required parameters are provided; otherwise, <c>null</c>.</returns>
