...
namespace DiGi.Geometry.Spatial.Random
{
    public static partial class Create
    {
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> within the specified <see cref="BoundingBox3D" />.
        /// </summary>
        ...
        /// <returns>A randomly generated <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> within the boundaries of the <paramref name="boundingBox3D" />, or <see langword="null" /> if the <paramref name="boundingBox3D" />, <paramref name="random" />, or the bounding box's minimum or maximum points are null.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> within the specified coordinate ranges.
        /// </summary>
        /// <param name="x">The <see cref="DiGi.Core.Classes.Range{T}" /> defining the boundaries for the X-coordinate.</param>
        /// <param name="y">The <see cref="DiGi.Core.Classes.Range{T}" /> defining the boundaries for the Y-coordinate.</param>
        /// <param name="z">The <see cref="DiGi.Core.Classes.Range{T}" /> defining the boundaries for the Z-coordinate.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> instance if all provided ranges are non-null; otherwise, <see langword="null" />.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Spatial.Classes.Point3D"/> based on the specified coordinate ranges and tolerance.
        /// </summary>
        ...
        /// <param name="z">The <see cref="DiGi.Core.Classes.Range{T}"/> for the Z-coordinate.</param>
        /// <param name="random">The <see cref="System.Random"/> instance used to generate random values.</param>
        /// <param name="tolerance">The <see cref="double"/> tolerance value, which defaults to <see cref="DiGi.Core.Constants.Tolerance.MacroDistance"/>.</param>
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Point3D"/> if <paramref name="x"/>, <paramref name="y"/>, <paramref name="z"/>, and <paramref name="random"/> are not null; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> within the specified <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D" /> using a provided seed and tolerance.
        /// </summary>
        /// <param name="polygon3D">The <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D" /> from which to generate the point.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> located within the <paramref name="polygon3D" />, or <see langword="null" /> if the <paramref name="polygon3D" /> is <see langword="null" />.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> within the boundaries of the specified <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D" />.
        /// </summary>
        /// <param name="polygon3D">The <see cref="DiGi.Geometry.Spatial.Classes.Polygon3D" /> instance used as the boundary for generating the point.</param>
        /// <param name="random">The <see cref="System.Random" /> instance used to generate random coordinates.</param>
        /// <param name="tolerance">The <see cref="double" /> tolerance value, which defaults to <see cref="DiGi.Core.Constants.Tolerance.MacroDistance" />.</param>
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> instance representing a random point within the <paramref name="polygon3D" />, or <c>null</c> if the <paramref name="polygon3D" /> is null, its associated plane is not defined, or a valid 2D point cannot be generated.</returns>
