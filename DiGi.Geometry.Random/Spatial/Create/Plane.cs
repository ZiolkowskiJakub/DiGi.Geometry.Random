...
namespace DiGi.Geometry.Spatial.Random
{
    ...
    {
        /// <summary>
        /// Generates a <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> based on the provided <see cref="BoundingBox3D" />, using a random seed and a specified tolerance.
        /// </summary>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> instance if the <paramref name="boundingBox3D" /> is not null; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> based on the provided <see cref="BoundingBox3D" />, <see cref="System.Random" /> instance, and tolerance.
        /// </summary>
        ...
        /// <returns>A randomly generated <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> if successful; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Generates a <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> based on the specified coordinate ranges.
        /// </summary>
        /// <param name="x">The range of the X-axis as a <see cref="DiGi.Core.Classes.Range{T}" /> of <see cref="double" /> values.</param>
        /// <param name="y">The range of the Y-axis as a <see cref="DiGi.Core.Classes.Range{T}" /> of <see cref="double" /> values.</param>
        /// <param name="z">The range of the Z-axis as a <see cref="DiGi.Core.Classes.Range{T}" /> of <see cref="double" /> values.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> instance if <paramref name="x" />, <paramref name="y" />, and <paramref name="z" /> are not null; otherwise, <c>null</c>.</returns>
        ...
        /// <summary>
        /// Generates a random <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> based on the provided coordinate ranges, a random number generator, and a tolerance value.
        /// </summary>
        /// <param name="x">The <see cref="DiGi.Core.Classes.Range{T}"/> defining the range for the X-coordinate of the point on the plane.</param>
        /// <param name="y">The <see cref="DiGi.Core.Classes.Range{T}"/> defining the range for the Y-coordinate of the point on the plane.</param>
        /// <param name="z">The <see cref="DiGi.Core.Classes.Range{T}"/> defining the range for the Z-coordinate of the point on the plane.</param>
        ...
        /// <returns>A <see cref="DiGi.Geometry.Spatial.Classes.Plane" /> instance if a valid <see cref="DiGi.Geometry.Spatial.Classes.Point3D" /> and <see cref="DiGi.Geometry.Spatial.Classes.Vector3D" /> can be generated; otherwise, <c>null</c>.</returns>
